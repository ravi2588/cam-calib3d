...
namespace CommandLineExamples {
  ...
  /// <summary>
  /// 3D Feature tracking in live stream from camera.
  /// </summary>
  /// <example>
  /// CommandLineExamples.exe run LiveFeatureTracking /ModelImage=../etc/patterns/feature/box.png /CameraCalibration=calibration.cr
  /// </example>
  public class LiveFeatureTracking : IExample {
    ...
    class CommandLineArguments {
      ...
      [Description("Path to model image")]
      public string ModelImage { get; set; }

      [Description("Path to camera calibration")]
      public string CameraCalibration { get; set;}

      [Description("Size of model image rectangle in units of calibration")]
      public System.Drawing.Size? ModelImageSize { get; set; }
    ...
    public string Description {
      get { return "Marker tracking in live stream from camera."; }
    }
    ...
    public void Run(string[] args) {
      ...
      string camera_calib_path = Default.Get(a.CameraCalibration, "calib.cr");
      int device_id = Default.Get(a.HardwareId, 0);
      System.Drawing.Size model_size = Default.Get(a.ModelImageSize, new System.Drawing.Size(100,100));
      ...
      Calib3D.IO.Images.Show(pat.Image, 1, "Model Image");
